const CompletedTask = ({ task }) => {
  ...
  return (
    <div
      className={`flex-shrink-0 w-[280px] sm:w-[320px] md:w-[360px] h-[370px] bg-gradient-to-br from-teal-600 to-teal-700 text-gray-100 rounded-2xl shadow-xl p-6 hover:shadow-2xl snap-center flex flex-col`}
    >
      ...
      <div className="flex gap-3 mt-auto pt-6">
        <button className="flex-1 bg-gradient-to-r from-green-500 to-green-700 hover:from-green-600 hover:to-green-800 text-white font-semibold py-2 px-4 rounded-lg transition duration-200 text-sm sm:text-base">
          Completed!
        </button>
      </div>
    </div>
